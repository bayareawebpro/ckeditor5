...
export default class InsertLinks extends BasicPlugin {
    ...
    get selectedText(){
        const position = this.editor.model.document.selection
        const selected = this.editor.model.getSelectedContent(position)
        return (selected.getChild(0) || {data: null}).data
    }
}
